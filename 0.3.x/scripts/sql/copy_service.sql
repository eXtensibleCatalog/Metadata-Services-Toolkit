...
delete from services where service_id=199;
insert into services (
	service_id,
	service_name,
	service_jar,
...
select 
	199,
	'db transformation service',
	service_jar,
	service_configuration,
	'xc.mst.services.transformation.DBTransformationService',
	...
	is_deleted
from services 
where identifier='MARCToXCTransformation';

delete from services_to_input_formats where service_id=199;
insert services_to_input_formats (
	service_id,
	format_id
)
select 199, s2.format_id
from services_to_input_formats s2,
	services s
where s.identifier='MARCToXCTransformation'
	and s.service_id = s2.service_id;

delete from services_to_output_formats where service_id=199;
insert services_to_output_formats (
	service_id,
	format_id
)
