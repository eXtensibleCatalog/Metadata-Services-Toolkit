...
public class ProcessingDirective {
     ...
     *            The new value for the processing directive ID
     */
     ...
     *            The new provider which can trigger the processing directive
     */
     ...
     * 
     * @param sourceService
     *            The new service which can trigger the processing directive
     */
     ...
     * 
     * @param service
     *            The new service which will be run on records triggering the
     *            processing directive
     */
     ...
     * 
     * @param outputSet
     *            The new set to which records processed by the service from the
     *            processing directive will be added
     */
     ...
     * by the service from the processing directive.
     * 
     * @param maintainSourceSets
     *            True if the source sets should be maintained by records processed
     ...
     * 
     * @param triggeringFormats
     *            A list formats that trigger the processing directive
     */
     ...
     * 
     * @param triggeringFormat
     *            The format to add to the list of formats that trigger the processing directive
     */
     ...
     * 
     * @param triggeringFormat
     *            The format to remove from the list of formats that trigger the processing directive
     */
     ...
     * 
     * @param triggeringSets
     *            A list sets that trigger the processing directive
     */
     ...
     * 
     * @param triggeringSet
     *            The set to add to the list of sets that trigger the processing directive
     */
     ...
     * 
     * @param triggeringSet
     *            The set to remove from the list of sets that trigger the processing directive
     */
