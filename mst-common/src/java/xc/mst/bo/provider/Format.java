...
public class Format
{
	 ...
	 *
	 * @param name The format's new name
	 */
	 ...
	 *
	 * @param namespace The format's new namespace
	 */
	 ...
	 *
	 * @param schemaLocation The format's new schema location
	 */
