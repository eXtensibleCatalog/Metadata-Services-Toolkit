...
public abstract class ProcessingDirectiveInputFormatUtilDAO extends BaseDAO {
     ...
     *            The ID of the processing directive the format is input for
     * @param formatId
     *            The ID of the format that is input for the processing directive
     ...
     * 
     * @param processingDirectiveId
     *            The ID of the processing directive the format is no longer input for
     * @param formatId
     *            The ID of the format that is no longer input for the processing directive
     * @return True on success, false on failure
     */
     ...
     * 
     * @param processingDirectiveId
     *            The ID of the processing directive whose input format IDs should be returned
     ...
     * 
     * @param processingDirectiveId
     *            The ID of the processing directive whose input formats should be removed
     * @return True on success, false on failure
     */
