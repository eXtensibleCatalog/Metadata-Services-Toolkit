...
public abstract class GroupDAO extends BaseDAO
{
     ...
     * @throws DataException if the passed group was not valid for inserting
     */
     ...
     * @return True on success, false on failure
     * @throws DataException if the passed group was not valid for updating
     */
     ...
     * @return True on success, false on failure
     * @throws DataException if the passed group was not valid for deleting
     */
     ...
     * @throws DataException If one or more of the fields on the passed group were invalid
     */
