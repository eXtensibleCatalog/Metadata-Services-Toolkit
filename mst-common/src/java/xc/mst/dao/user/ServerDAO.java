...
public abstract class ServerDAO extends BaseDAO
{
     ...
     * @throws DataException if the passed server was not valid for inserting
     */
     ...
     * @return True on success, false on failure
     * @throws DataException if the passed server was not valid for updating
     */
     ...
     * @return True on success, false on failure
     * @throws DataException if the passed server was not valid for deleting
     */
     ...
     * @throws DataException If one or more of the fields on the passed server were invalid
     */
