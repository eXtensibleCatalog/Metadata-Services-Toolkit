...
public interface ProcessingDirectiveService {
     ...
     *            The ID based on which the processing Directive object is retrieved
     * @return
     * @throws DatabaseConfigException
     */
     ...
     *            The processing Directive Object to be inserted
     */
     ...
     * 
     * @param processingDirective
     *            The processingDirective Object to be deleted
     */
     ...
     * 
     * @param processingDirective
     *            The processing directive to be updated
     */
