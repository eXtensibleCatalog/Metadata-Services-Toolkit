...
public abstract class ItemService extends BaseService {
     ...
     * 
     * @param type
     *            The type attribute of the holdingsExemplified element
     * @param value
     *            The value of the holdingsExemplified element
     ...
     * Gets a list of Items that match the passed holdingsExemplified
     * 
     * @param holdingsExemplified
     *            The holdingsExemplified we're querying for in the
     *            format (<type>)<value>
     ...
     * 
     * @param The
     *            XC item ID of the target item element
     ...
     * 
     * @param holdings
     *            The holdings whose linked Items should be returned
     */
     ...
     * 
     * @param doc
     *            The document containing information on the Item.
     ...
     * 
     * @param item
     *            The item to use to set the fields on the document
     * @param doc
     *            The document whose fields need to be set.
     * @param generateNewId
     *            True to generate a new record ID for the item, false to use the item's current ID
     ...
     *             If one or more of the fields on the passed item were invalid
     */
