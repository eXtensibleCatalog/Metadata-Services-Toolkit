...
public abstract class ManifestationService extends BaseService {
     ...
     * 
     * @param type
     *            The type attribute of the XC record ID element
     * @param value
     *            The value of the XC record ID element
     ...
     * 
     * @param xcRecordId
     *            The XC record ID we're querying for in the
     *            format (<type>)<value>
     * @return A list of Manifestations with the requested XC record ID element.
     */
     ...
     *            The XC manifestation ID of the target manifestation element
     ...
     * 
     * @param expression
     *            The expression whose linked Manifestations should be returned
     */
     ...
     * 
     * @param doc
     *            The document containing information on the Manifestation.
     ...
     * 
     * @param manifestation
     *            The manifestation to use to set the fields on the document
     * @param doc
     *            The document whose fields need to be set.
     * @param generateNewId
     *            True to generate a new record ID for the manifestation, false to use the manifestation's current ID
     ...
     * 
     * @param manifestation
     *            The manifestation to validate
     * @param validateId
     *            true if the ID field should be validated
     * @param validateNonId
     *            true if the non-ID fields should be validated
     * @throws DataException
     *             If one or more of the fields on the passed manifestation were invalid
     */
