...
public interface ProviderService {
     ...
     * 
     * @param providerId
     *            The ID of the provider object to be returned
     * @return Provider Object
     * @throws DatabaseConfigException
     */
     ...
     * 
     * @param provider
     *            The provider object to be inserted
     */
     ...
     * 
     * @param provider
     *            The Provider Object to be Updated
     */
     ...
     * @param columnSorted
     *            column on which the sorting is done
     ...
     * 
     * @param provider
     *            - the provider whose records we will mark deleted
     */
