...
public interface GroupService {
     ...
     * 
     * @param groupId
     *            Specifies the ID of the group object to be returned
     ...
     *            determines whether the list of groups is to be sorted in ascending or descending order
     * @param columnSorted
