...
public interface UserGroupUtilService {
     ...
     * 
     * @param userId
     *            The User Id for whom a list of Group IDs is returned.
     * @return
     */
     ...
     * 
     * @param userId
     *            The UserId for which all associations should be deleted
     */
     ...
     * 
     * @param userId
     *            The user ID to be associated with a Group
     * @param groupId
     *            The group ID to be associated with a User
     */
     ...
     * 
     * @param userId
     *            The user ID that is associated with a Group
     * @param groupId
     *            The group ID that is associated with a user
     */
