...
public interface UserService {
     ...
     *             Thrown when problem in deleting the user
     */
     ...
     * 
     * @param user
     *            user to inserted into the database
     */
     ...
     * 
     * @param user
     *            user whose details should be updated in the database
     */
     ...
     * 
     * @param comments
     *            message error message which describes where the error took place.
     * @throws DatabaseConfigException
     */
