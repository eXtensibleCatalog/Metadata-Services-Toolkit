...
public abstract class GenericMetadataService extends SolrMetadataService
     ...
     *            <ul>
     *            <li>
     *            If this InputRecord has been deleted, then the status will be
     *            Record.DELETED. Otherwise it will be Record.ACTIVE.</li>
     *            </ul>
     *            </li>
     *            <li>
     *            r.successors
     *            <ul>
     *            <li>
     *            If this InputRecord has been processed before (determined by
     *            the oai-id), then the record will have successor Records
     *            attached to it. The only data attached to these records is the
     *            id. The content (xml) is not attached. If implementers find it
     *            necessary to have this, we may provide an optional way to get
     *            that content.</li>
     *            </ul>
     *            </li>
     *            <li>
     ...
     *            <ul>
     *            <li>
     *            If this InputRecord has successors associated with it, then
     *            the predecessors of the successors will also be attached. As
     *            with InputRecord.successors, these predecessor records only
     *            have the id associated with them. For a typical one-to-one
     *            service, this data is somewhat redundant. But for more complex
     *            services in which a Record may have more than one predecessor,
     *            it becomes necessary.</li>
     *            </ul>
     *            </li>
     *            </ul>
     ...
     *         <ul>
     *         <li>
     *         If a record already exists with this id, then that record will be
     *         overwritten with the new contents. If this id is left blank, then
     *         the MST will assign it a new id.</li>
     *         </ul>
     *         </li>
     *         <li>
     *         OutputRecord.status
     *         <ul>
     *         <li>
     *         Record.ACTIVE (default) - Record will be made available for
     *         oai-pmh harvesting once persisted.</li>
     *         <li>
     *         Record.HELD - Record will be persisted and will await further
     *         notice to be made active. These records are not included in
     *         oai-pmh responses.</li>
     *         <li>
     *         Record.DELETED - Record will be marked as deleted. These records
     *         are included in oai-pmh responses.</li>
     *         </ul>
     *         </li>
     *         </ul>
     * 
	...
	if (!isSolrIndexer()) {
		...
		getRepositoryDAO().persistPreviousStatuses(
			getRepository().getName(), tempPreviousStatuses);
