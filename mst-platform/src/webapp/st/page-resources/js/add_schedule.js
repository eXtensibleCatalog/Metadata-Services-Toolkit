		...
		if (selectedRecurrence == '') {
			...
			if (selectedRecurrence=='Daily') {
				if (document.scheduleForm.dailyHour.value=='-1') {
					createErrorDiv('error','Hour to harvest the repository is required.');
					return false;
				}
				if (document.scheduleForm.dailyMinute.value=='-1') {
					createErrorDiv('error','Minute to harvest the repository is required.');
					return false;
				}				
			}
