                             ...
                             <c:choose>
                                 <c:when test="${empty groupList}">
                                     <div class="emptytablebar">
                                         <div class="emptytable_innerdiv"> Choose <b>List Groups</b> <img class="emptytable_img" src="page-resources/img/bullet_go.gif"/> <b>Add Group</b> to add a group </div>
                                     </div>
                                </c:when>
                                <c:otherwise>
                                        <c:forEach var="group" items="${groupList}" varStatus="groupCount">
                                             <tr>
                                                ...
                                                <td class="${classColumn}"><a href="viewEditGroup.action?groupId=<c:out value="${group.id}"/>">${group.name}</a></td>
