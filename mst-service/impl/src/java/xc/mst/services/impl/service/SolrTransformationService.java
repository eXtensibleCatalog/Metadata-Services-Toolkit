...
public abstract class SolrTransformationService extends GenericMetadataService {
	...
	protected void holdingsProcess004(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto) {
	 ...
	 */
	protected AggregateXCRecord process010(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Create an xc:recordID with a type of LCCN based on the 010 $a values
		return processFieldBasic(transformMe, transformInto, 10, 'a', "recordID", AggregateXCRecord.XC_NAMESPACE, new Attribute("type", "LCCN"), FrbrLevel.MANIFESTATION);
	}
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process015(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Create an xc:identifier based on the 015 $a values with a type based on the corrosponding 015 $2 value
		return processFieldAttributeFromSubfield(transformMe, transformInto, 15, 'a', "identifier", AggregateXCRecord.XC_NAMESPACE, new Attribute("type", "null"), '2', null, FrbrLevel.MANIFESTATION);
	}
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process016(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Create an xc:identifier based on the 015 $a values with a type based on the corrosponding 015 $2 value
		return processFieldAttributeFromSubfield(transformMe, transformInto, 16, 'a', "identifier", AggregateXCRecord.XC_NAMESPACE, new Attribute("type", "null"), '2', "LAC", FrbrLevel.MANIFESTATION);
	}
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process022(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Create an identifier with a type of ISSN based on the 022 $a values
		transformInto = processFieldBasic(transformMe, transformInto, 22, 'a', "identifier", AggregateXCRecord.XC_NAMESPACE, new Attribute("type", "ISSN"), FrbrLevel.MANIFESTATION);

		// Create an identifier with a type of ISSN-L based on the 022 $l values
		return processFieldBasic(transformMe, transformInto, 22, 'l', "identifier", AggregateXCRecord.XC_NAMESPACE, new Attribute("type", "ISSN-L"), FrbrLevel.MANIFESTATION);
	}
	...
	/**
	 * Processes the 028 field from the SaxMarcXmlRecord we're transforming.  This becomes
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process028(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process030(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Create an identifier with a type of CODEN based on the 030 $a values
		return processFieldBasic(transformMe, transformInto, 30, 'a', "identifier", AggregateXCRecord.XC_NAMESPACE, new Attribute("type", "CODEN"), FrbrLevel.MANIFESTATION);
	}
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process035(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process037(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		...
		for(Field element : elements)
		{
			...
			List<String> requestedSubfields = SaxMarcXmlRecord.getSubfieldOfField(element, 'a');
			List<String> requestedAttributeSubfields = SaxMarcXmlRecord.getSubfieldOfField(element, 'b');
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process050(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 055 field from the SaxMarcXmlRecord we're transforming.  Each one with a 1st indicator
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process055(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process060(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Create an dcterms:subject with a type of LCCN based on the 060 $a values
		return processFieldBasic(transformMe, transformInto, 60, 'a', "subject", AggregateXCRecord.DCTERMS_NAMESPACE, new Attribute("type", "dcterms:NLM",AggregateXCRecord.XSI_NAMESPACE), FrbrLevel.WORK);
	}
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process074(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Create an xc:identifier with a type of GPOItem based on the 074 $a values
		return processFieldBasic(transformMe, transformInto, 74, 'a', "identifier", AggregateXCRecord.XC_NAMESPACE, new Attribute("type", "GPOItem"), FrbrLevel.MANIFESTATION);
	}
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process082(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Create an dcterms:subject with a xsi:type of dcterms:DDC based on the 082 $a values
		return processFieldBasic(transformMe, transformInto, 82, 'a', "subject", AggregateXCRecord.DCTERMS_NAMESPACE, new Attribute("type", "dcterms:DDC", AggregateXCRecord.XSI_NAMESPACE), FrbrLevel.WORK);
	}
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process084(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		...
		if (subfieldValues != null) {
			for (String subfieldValue : subfieldValues) {
				if (subfieldValue.equalsIgnoreCase("NDC8")) {
					// Create an dcterms:subject with a xsi:type of dcterms:DDC based on the 082 $a values
					return processFieldBasic(transformMe, transformInto, 84, 'a', "subject", AggregateXCRecord.XC_NAMESPACE, new Attribute("type", "NDC8"), FrbrLevel.WORK);
				}
			}
		}
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process086(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Create an xc:identifier with a type of SuDoc based on the 086 $a values
		return processFieldBasic(transformMe, transformInto, 86, 'a', "identifier", AggregateXCRecord.XC_NAMESPACE, new Attribute("type", "SuDoc"), FrbrLevel.MANIFESTATION);
	}
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process090(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Create a xc:subject with a type of dcterms:LCC based on the 090 $a values
		return processFieldBasic(transformMe, transformInto, 90, 'a', "subject", AggregateXCRecord.DCTERMS_NAMESPACE, new Attribute("type", "dcterms:LCC", AggregateXCRecord.XSI_NAMESPACE), FrbrLevel.WORK);
	}
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process092(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Create an dcterms:subject with a xsi:type of dcterms:DDC based on the 092 $a values
		return processFieldBasic(transformMe, transformInto, 92, 'a', "subject", AggregateXCRecord.DCTERMS_NAMESPACE, new Attribute("type", "dcterms:DDC", AggregateXCRecord.XSI_NAMESPACE), FrbrLevel.WORK);
	}

	/**
	 * Processes the 100 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process100(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 110 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process110(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 111 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process111(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 130 field from the SaxMarcXmlRecord we're transforming.
	...
	protected AggregateXCRecord process130(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Get the elements with the requested tags in the MARC XML record
		...
		for(Field element : elements)
		{
			...
			for(Subfield subfield : subfields)
			{
				...
				if(targetTitleOfExpressionBuilderSubfields.indexOf(subfieldCode) != -1)
	...
	/**
	 * Processes the 210 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process210(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 222 field from the SaxMarcXmlRecord we're transforming.
	 * The $a and $b become the dcterms:alternative field at the manifestation FRBR level.
	 *
	 * @param transformMe The MARC XML record we're transforming
	 * @param transformInto The XC record which will store the transformed version of the record
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process222(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 240 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 */
	@SuppressWarnings("unchecked")
	protected AggregateXCRecord process240(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Get the elements with the requested tags in the MARC XML record
	...
	/**
	 * Processes the 243 field from the SaxMarcXmlRecord we're transforming.
	 * The $0 becomes the rdvocab:identifierForTheWork field at the work FRBR level.
	 * The adfghklmnoprs subfields become the rdvocab:workTitle field at the work FRBR level.
	 * and the xc:expressionTitle field at the expression FRBR level.
	 *
	 ...
	 */
	@SuppressWarnings("unchecked")
	protected AggregateXCRecord process243(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Get the elements with the requested tags in the MARC XML record
	...
	/**
	 * Processes the 245 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process245(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 246 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 */
	@SuppressWarnings("unchecked")
	protected AggregateXCRecord process246(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 247 field from the SaxMarcXmlRecord we're transforming.
	 * The abfnp subfields become the dcterms:alternative field at the manifestation FRBR level.
	 *
	 * @param transformMe The MARC XML record we're transforming
	 * @param transformInto The XC record which will store the transformed version of the record
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process247(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 250 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process250(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 254 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process254(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Get the target subfields MARC XML record
	...
	/**
	 * Processes the 255 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process255(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 260 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process260(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 300 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process300(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 310 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process310(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 321 field from the SaxMarcXmlRecord we're transforming.
	 * The ab subfields become the rdvocab:frequency field at the manifestation FRBR level.
	 *
	 * @param transformMe The MARC XML record we're transforming
	 * @param transformInto The XC record which will store the transformed version of the record
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process321(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 362 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process362(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 440 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process440(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 490 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process490(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 500 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process500(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 501 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process501(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 502 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process502(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 504 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process504(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 505 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process505(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 506 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process506(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 507 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process507(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 508 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process508(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 510 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process510(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 511 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process511(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 513 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process513(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 515 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process515(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 518 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process518(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 520 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process520(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 521 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process521(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 522 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process522(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process525(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 530 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process530(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 533 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process533(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 534 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process534(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 538 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process538(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 540 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process540(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 544 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process544(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 546 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process546(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 547 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process547(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process550(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 555 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process555(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 580 field from the SaxMarcXmlRecord we're transforming.
	 * The $a subfields become dc:relation fields at the expression FRBR level.
	 *
	 * @param transformMe The MARC XML record we're transforming
	 * @param transformInto The XC record which will store the transformed version of the record
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process580(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 586 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process586(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 59X field from the SaxMarcXmlRecord we're transforming.
	 * The $a subfields become dc:description fields at the manifestation FRBR level.
	 *
	 * @param transformMe The MARC XML record we're transforming
	 * @param transformInto The XC record which will store the transformed version of the record
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process59X(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process653(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 654 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process654(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 700 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 */
	@SuppressWarnings("unchecked")
	protected AggregateXCRecord process700(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Get the elements with the requested field
		...
		for(Field element : elements)
		{
			...
			if(tFields.size() <= 0)
			{
				...
				List<String> authorityFields = SaxMarcXmlRecord.getSubfieldOfField(element, '0');
				...
				List<String> roleSubfields = SaxMarcXmlRecord.getSubfieldOfField(element, '4');
			...
			{ 
				...
				if(ind2 == '2')
				{
					...
					for(Subfield subfield : subfields){
						...
						if(subfieldCode == '0')
							transformInto = addElementForAuthority(transformMe, transformInto, 700, subfield.getContents(), linkingTag);
					}
	...
	/**
	 * Processes the 710 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 */
	@SuppressWarnings("unchecked")
	protected AggregateXCRecord process710(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Get the elements with the requested field
			...
			else
			{
				if(ind2 == '2')
				{
					...
					for(Subfield subfield : subfields)
					{
						...
						if(subfieldCode == '0')
							transformInto = addElementForAuthority(transformMe, transformInto, 710, subfield.getContents(), linkingTag);
					}
	 ...
	 */
	@SuppressWarnings("unchecked")
	protected AggregateXCRecord process711(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Get the elements with the requested field
			...
			else
			{
				if(ind2 == '2')
				{
					...
					for(Subfield subfield : subfields)
					{
						...
						if(subfieldCode == 0)
							transformInto = addElementForAuthority(transformMe, transformInto, 711, subfield.getContents(), linkingTag);
					}
	...
	/**
	 * Processes the 720 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process720(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	 ...
	 */
	@SuppressWarnings("unchecked")
	protected AggregateXCRecord process730(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Get the elements with the requested field
		...
		for(Field element : elements)
		{
			...
			if(ind2 == '2')
			{
				...
				for(Subfield subfield : subfields)
				{
					...
					if(subfieldCode == '0')
						transformInto = addElementForAuthority(transformMe, transformInto, 730, subfield.getContents(), "730" + artificialLinkingId);
				}
			...
			else
			{
				...
				// Get the $0 fields; they contain the authority information
				List<String> issnFields = SaxMarcXmlRecord.getSubfieldOfField(element, 'x');
	...
	/**
	 * Processes the 740 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process740(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 752 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process752(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 760 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process760(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 765 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process765(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 770 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process770(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Create a HashMap mapping the $x subfield to a dcterms:ISSN attribute and the $z subfield to a dcterms:ISBN attribute
		HashMap<Character, Attribute> subfieldToAttribute = new HashMap<Character, Attribute>();
		subfieldToAttribute.put('x', new Attribute("ISSN", "", AggregateXCRecord.DCTERMS_NAMESPACE));
	...
	/**
	 * Processes the 772 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process772(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Create a HashMap mapping the $x subfield to a dcterms:ISSN attribute and the $z subfield to a dcterms:ISBN attribute
		HashMap<Character, Attribute> subfieldToAttribute = new HashMap<Character, Attribute>();
		subfieldToAttribute.put('x', new Attribute("ISSN", "", AggregateXCRecord.DCTERMS_NAMESPACE));
	...
	/**
	 * Processes the 773 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process773(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Create a HashMap mapping the $x subfield to a dcterms:ISSN attribute and the $z subfield to a dcterms:ISBN attribute
		HashMap<Character, Attribute> subfieldToAttribute = new HashMap<Character, Attribute>();
		subfieldToAttribute.put('x', new Attribute("ISSN", "", AggregateXCRecord.DCTERMS_NAMESPACE));
	...
	/**
	 * Processes the 775 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process775(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Create a HashMap mapping the $x subfield to a dcterms:ISSN attribute and the $z subfield to a dcterms:ISBN attribute
		HashMap<Character, Attribute> subfieldToAttribute = new HashMap<Character, Attribute>();
		subfieldToAttribute.put('x', new Attribute("ISSN", "", AggregateXCRecord.DCTERMS_NAMESPACE));
	...
	/**
	 * Processes the 776 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process776(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Create a HashMap mapping the $x subfield to a dcterms:ISSN attribute and the $z subfield to a dcterms:ISBN attribute
		HashMap<Character, Attribute> subfieldToAttribute = new HashMap<Character, Attribute>();
		subfieldToAttribute.put('x', new Attribute("ISSN", "", AggregateXCRecord.DCTERMS_NAMESPACE));
	...
	/**
	 * Processes the 777 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process777(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 780 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process780(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Create the subfield to attribute map.
		// We'll map the $x subfield to a dcterms:ISSN attribute
	...
	/**
	 * Processes the 785 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process785(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Create the subfield to attribute map.
		// We'll map the $x subfield to a dcterms:ISSN attribute
		// and the $z subfield to the dcterms:ISBN attribute
	...
	/**
	 * Processes the 786 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process786(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Create a HashMap mapping the $x subfield to a dcterms:ISSN attribute and the $z subfield to a dcterms:ISBN attribute
		HashMap<Character, Attribute> subfieldToAttribute = new HashMap<Character, Attribute>();
		subfieldToAttribute.put('x', new Attribute("ISSN", "", AggregateXCRecord.DCTERMS_NAMESPACE));
	...
	/**
	 * Processes the 787 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process787(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Create a HashMap mapping the $x subfield to a dcterms:ISSN attribute and the $z subfield to a dcterms:ISBN attribute
		HashMap<Character, Attribute> subfieldToAttribute = new HashMap<Character, Attribute>();
		subfieldToAttribute.put('x', new Attribute("ISSN", "", AggregateXCRecord.DCTERMS_NAMESPACE));
	...
	/**
	 * Processes the 800 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process800(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 810 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process810(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 811 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process811(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 830 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process830(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	 ...
	 * Processes the 843 field from the SaxMarcXmlRecord we're transforming.
	 * The abcdefmn subfields become the xc:description field at the holdings FRBR level.
	 *
	 * @param transformMe The MARC XML record we're transforming
	 * @param transformInto The XC record which will store the transformed version of the record
	 * @return A reference to transformInto after this transformation step has been completed.
	protected XCRecord holdingsProcess843(SaxMarcXmlRecord transformMe, XCRecord transformInto)
	{
	...
	*/
	...
	/**
	 * Processes the 852 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 */
	@SuppressWarnings("unchecked")
	protected AggregateXCRecord process852(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Get the elements with the requested tags in the MARC XML record
		...
		for(Field element : elements)
		{
			...
			for(Subfield subfield : subfields)
			{
				...
				if(	SaxMarcXmlRecord.getIndicatorOfField(element, 1) == '0' && subfieldCode == 'h') 
				{
					...
					for (int i = 0; i < subfield.getContents().toCharArray().length ; i++) {
						...
						if( i==0 && Character.isLetter(subfield.getContents().charAt(i)))
							mapFlag = true;
						// Second character should be a letter
						else if(i==1 && Character.isLetter(subfield.getContents().charAt(i)))
							mapFlag = true;
						// Other characters should be numerals
						else if(!Character.isLetter(subfield.getContents().charAt(i)) )
							mapFlag = true;
						// Do not map
						else
						{
					...
					if(mapFlag)
						subjectLCCBuilder = subjectLCCBuilder.append(subfield.getContents());
				...
				else if(SaxMarcXmlRecord.getIndicatorOfField(element, 1) == '1' && subfieldCode == 'h')
				{
					...
					for (int i = 0; i < subfield.getContents().toCharArray().length ; i++) {
						...
						if( i==0 && Character.isDigit(subfield.getContents().charAt(i)))
							mapFlag = true;
						// Second character should be a numeral
						else if(i==1 && Character.isDigit(subfield.getContents().charAt(i)))
							mapFlag = true;
						// Other characters should be a characters
						else if(!Character.isDigit(subfield.getContents().charAt(i)) )
							mapFlag = true;
						// Do not map
						else
						{
					...
					if(mapFlag)
						subjectDDCBuilder = subjectDDCBuilder.append(subfield.getContents());				
			...
			for (Field sibling : relevantSiblings) {
				...
				for(Subfield siblingSubfield : siblingSubfields)
				{
					...
					if(textualHoldingsTargetSubfields.indexOf(siblingSubfieldCode) != -1)
						textualHoldingsBuilder.append(siblingSubfield.getContents() + " ");
				}
	...
	/**
	 * Processes the 856 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 */
	@SuppressWarnings("unchecked")
	protected AggregateXCRecord process856(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Get the elements with the requested field
	...
	/**
	 * Processes the 866 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process866(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Get the elements with the requested field
		List<Field> elements = transformMe.getDataFields(852);
	...
	/**
	 * Processes the 867 field from the SaxMarcXmlRecord we're transforming.
	 * The az subfields become the xc:textualHoldings field at the holdings FRBR level.
	 *
	 * @param transformMe The MARC XML record we're transforming
	 * @param transformInto The XC record which will store the transformed version of the record
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process867(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Get the elements with the requested field
		List<Field> elements = transformMe.getDataFields(852);
	...
	/**
	 * Processes the 868 field from the SaxMarcXmlRecord we're transforming.
	 * The az subfields become the xc:textualHoldings field at the holdings FRBR level.
	 *
	 * @param transformMe The MARC XML record we're transforming
	 * @param transformInto The XC record which will store the transformed version of the record
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process868(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Get the elements with the requested field
		List<Field> elements = transformMe.getDataFields(852);
	...
	/**
	 * Processes the 931 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process931(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 932 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process932(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 933 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process933(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 934 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process934(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 935 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process935(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 937 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process937(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 939 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process939(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 943 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process943(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 945 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 */
	@SuppressWarnings("unchecked")
	protected AggregateXCRecord process945(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 947 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord process947(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	...
	/**
	 * Processes the 959 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 */
	@SuppressWarnings("unchecked")
	protected AggregateXCRecord process959(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Get the elements with the requested tags in the MARC XML record
		...
		for(Field element : elements)
		{
			...
			// Get the needed subfields of the element
			List<String> requestedAttributeSubfields = SaxMarcXmlRecord.getSubfieldOfField(element, '0');
			List<String> linkingFields = SaxMarcXmlRecord.getSubfieldOfField(element, '8');
			List<Subfield> subfields = element.getSubfields();
	...
	/**
	 * Processes the 963 field from the SaxMarcXmlRecord we're transforming.
	...
	/**
	 * Processes the 965 field from the SaxMarcXmlRecord we're transforming.
	...
	/**
	 * Processes the 967 field from the SaxMarcXmlRecord we're transforming.
	...
	/**
	 * Processes the 969 field from the SaxMarcXmlRecord we're transforming.
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord holdingsProcess001And003(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord holdingsProcess506(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Create an dc:rights based on the 506 abcdefu3 values
		return processFieldBasic(transformMe, transformInto, 506, "abcdefu3", "rights", AggregateXCRecord.DCTERMS_NAMESPACE, null, FrbrLevel.MANIFESTATION);
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	protected AggregateXCRecord holdingsProcess856(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto)
	{
		// Get the elements with the requested field
		List<Field> elements = transformMe.getDataFields(856);
	...
	/**
	 * Process a data field from the SaxMarcXmlRecord we're transforming and create the specified
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord processFieldBasic(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto, 
			int field, char subfield, String elementName, Namespace elementNamespace, 
	...
	@SuppressWarnings("unchecked")
	protected AggregateXCRecord processFieldBasic(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto, 
			int field, String targetSubfields, String elementName, Namespace elementNamespace, 
			Attribute elementAttribute, FrbrLevel level) {
		// Get the elements with the requested tags in the MARC XML record
	 ...
	 */
	@SuppressWarnings("unchecked")
	protected AggregateXCRecord processFieldBasicDashSubfields(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto, int field, String targetSubfields, String elementName, Namespace elementNamespace, Attribute elementAttribute, FrbrLevel level)
	{
		// Get the elements with the requested tags in the MARC XML record
		List<Field> elements = transformMe.getDataFields(field);
	 ...
	 * @return A reference to transformInto after this transformation step has been completed.
	 */
	protected AggregateXCRecord processFieldAttributeFromSubfield(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto, int field, char subfield, String elementName, Namespace elementNamespace, Attribute elementAttribute, char attributeSubfield, String defaultAttribute, FrbrLevel level)
	{
		// Get the elements with the requested tags in the MARC XML record
		List<Field> elements = transformMe.getDataFields(field);
		...
		{
			// Get the needed subfields of the element
			List<String> requestedSubfields = SaxMarcXmlRecord.getSubfieldOfField(element, subfield);
			List<String> requestedAttributeSubfields = SaxMarcXmlRecord.getSubfieldOfField(element, attributeSubfield);
	 ...
	 */
	@SuppressWarnings("unchecked")
	protected AggregateXCRecord processFieldAttributeFromSubfield(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto, int field, String targetSubfields, String elementName, Namespace elementNamespace, Attribute elementAttribute, char attributeSubfield, String defaultAttribute, FrbrLevel level)
	{
		// Get the elements with the requested tags in the MARC XML record
		List<Field> elements = transformMe.getDataFields(field);
	 ...
	 */
	@SuppressWarnings("unchecked")
	protected AggregateXCRecord processFieldAttributeFromSubfield(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto, int field, String targetSubfields, String dashSubfields, String elementName, Namespace elementNamespace, Attribute elementAttribute, char attributeSubfield, String defaultAttribute, FrbrLevel level)
	{
		// Get the elements with the requested tags in the MARC XML record
		List<Field> elements = transformMe.getDataFields(field);
		...
		for(Field element : elements)
		{
			...
			for(Subfield subfield : subfields)
			{
				...
				if(targetSubfields.indexOf(subfieldCode) != -1)
				{
					if(dashSubfields.indexOf(subfieldCode) != -1 && builder.length() > 0)
					{
	 ...
	 */
	@SuppressWarnings("unchecked")
	protected AggregateXCRecord processFieldAttributeFromSubfield(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto, int field, String targetSubfields, String elementName, Namespace elementNamespace, HashMap<Character, Attribute> subfieldToAttribute, FrbrLevel level)
	{
		// Get the elements with the requested tags in the MARC XML record
		List<Field> elements = transformMe.getDataFields(field);
	 ...
	 */
	@SuppressWarnings("unchecked")
	protected AggregateXCRecord processFieldWithAuthority(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto, int field, String targetSubfields, String elementName, Namespace elementNamespace, FrbrLevel level)
	{
		// Get the elements with the requested tags in the MARC XML record
		List<Field> elements = transformMe.getDataFields(field);
			...
			int targetIndicator, HashMap<Character, Attribute> indicatorToValue, FrbrLevel level)
	{
		...
		for(Field element : elements)
		{
			...
			// Get the needed subfields of the element
			List<String> requestedAttributeSubfields = SaxMarcXmlRecord.getSubfieldOfField(element, '0');
			LOG.debug("requestedAttributeSubfields: "+requestedAttributeSubfields);
			List<Subfield> subfields = element.getSubfields();
			...
			if(builder.length() > 0)
			{
				...
				if(attributeToUse.getValue().startsWith("$"))
				{
					...
					List<String> attSubfieldValues = SaxMarcXmlRecord.getSubfieldOfField(element, attributeToUse.getValue().charAt(1));
	 ...
	 */
	@SuppressWarnings("unchecked")
	protected AggregateXCRecord processFieldWithAuthorityAttributeFromSubfield(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto, int field, String targetSubfields, String elementName, Namespace elementNamespace, Attribute attribute, char attributeSubfield, FrbrLevel level)
	{
		// Get the elements with the requested tags in the MARC XML record
		List<Field> elements = transformMe.getDataFields(field);
		...
		{
			// Get the requested indicator
			List<String> attSubfieldValues = SaxMarcXmlRecord.getSubfieldOfField(element, attributeSubfield);
	 ...
	 */
	@SuppressWarnings("unchecked")
	protected AggregateXCRecord processFieldWithAuthorityIgnoreRoles(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto, int field, String targetSubfields, String defaultElementName, Namespace defaultElementNamespace, FrbrLevel defaultLevel)
	{
		// Get the elements with the requested tags in the MARC XML record
		List<Field> elements = transformMe.getDataFields(field);
		...
		for(Field element : elements)
		{
			...
			for(Subfield subfield : subfields)
			{
				...
				if(targetSubfields.indexOf(subfieldCode) != -1) {
					LOG.debug("subfield.getContents(): "+subfield.getContents());
					builder.append(subfield.getContents() + " ");
				}
			}
	...
	protected AggregateXCRecord processFieldReqIndicatorAttFromField(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto, int field, String targetSubfields, String elementName, Namespace elementNamespace, int targetIndicator, char indicatorRequiredValue, HashMap<Character, Attribute> fieldToAttribute, FrbrLevel level)
	{
		...
		if(elements.size() == 0)
			...
			for(Field element : elements)
			{
				...
				{
					// Get the required indicator
					int ind = SaxMarcXmlRecord.getIndicatorOfField(element, targetIndicator);
				...
				for(Subfield subfield : subfields)
				{
					...
					if(fieldToAttribute.containsKey(subfieldCode))
						attributes.add(((Attribute)fieldToAttribute.get(subfieldCode).clone()).setValue(subfield.getContents()));
					}
					catch (Exception e) {
						//TODO
	...
	protected Attribute getAttributeForAuthority(int tag, String valueOf0)
	{
		...
		else if(tag == 440 || tag == 730 || tag == 800 || tag == 810 || tag == 811 || tag == 830)
		{
			// If the prefix is "DLC" we should return an lcnaf attribute.
			// If it's the organization code we should return an xcauth attribute
			// Otherwise return null since we don't recognize the prefix
		...
		else if(tag == 600 || tag == 610 || tag == 611 || tag == 630 || tag == 650 || tag == 655 || tag == 965 || tag == 969)
		{
			// If the prefix is "DLC" we should return an lcnaf attribute.
			// If it's the organization code we should return an xcauth attribute
			// Otherwise return null since we don't recognize the prefix
	 ...
	 * @return
	 */
	protected AggregateXCRecord addElementForAuthority(SaxMarcXmlRecord transformMe, AggregateXCRecord transformInto, int tag, String valueOf0, String linkingField)
	{
		// Check that the $0 is in the format we're expecting: "(<prefix>)<value>"
		// If it isn't, we can't build an authority Attribute, so return null
		if(!valueOf0.contains("(") || !valueOf0.contains(")"))
