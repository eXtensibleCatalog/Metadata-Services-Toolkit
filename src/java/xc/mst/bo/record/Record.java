...
public class Record
{
	 ...
	 */
	private List<Log> warnings = new ArrayList<Log>();

	/**
	 * A list of errors generated by this record
	 */
	private List<Log> errors = new ArrayList<Log>();
	 ...
	 *
	 * @param traits The record's new warnings
	 */
	public void setWarnings(List<Log> warnings)
	{
		this.warnings = warnings;
	} // end method setWarnings(List<Log>)
	 ...
	 */
	public void addWarning(Log warning)
	{
		if(!warnings.contains(warning))
			warnings.add(warning);
	} // end method addWarning(Log)
	 ...
	 */
	public void removeWarning(Log warning)
	{
		if(warnings.contains(warning))
			warnings.remove(warning);
	} // end method removeWarning(Log)
	 ...
	 *
	 * @param traits The record's new errors
	 */
	public void setErrors(List<Log> errors)
	{
		this.errors = errors;
	} // end method setErrors(List<Log>)
	 ...
	 */
	public void removeError(Log error)
	{
		if(errors.contains(error))
			errors.remove(error);
	} // end method removeError(Log)
