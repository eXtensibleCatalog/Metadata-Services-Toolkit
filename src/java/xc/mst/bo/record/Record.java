...
public class Record
{
	...
	/**
	 * A list of warning codes generated by this record
	 */
	private List<String> warningCodes = new ArrayList<String>();

	/**
	 * A list of error codes generated by this record
	 */
	private List<String> errorCodes = new ArrayList<String>();
	
	/**
	 * A list of warnings generated by this record
	 */
...
//	private int numberOfSuccessor;
	...
	/**
	 * Gets the record's warning codes
	 *
	 * @return The record's warning codes
	 */
	public List<String> getWarningCodes()
	{
		return warningCodes;
	} // end method getWarningCodes()

	/**
	 * Sets the record's warning codes
	 *
	 * @param warningCodes The record's new warning codes
	 */
	public void setWarningCodes(List<String> warningCodes)
	{
		this.warningCodes = warningCodes;
	} // end method setWarningCodes(List<String>)

	/**
	 * Adds a warning code to the record
	 *
	 * @param warningCode The warning code to add to the record
	 */
	public void addWarningCode(String warningCode)
	{
		if(!warningCodes.contains(warningCode))
			warningCodes.add(warningCode);
	} // end method addWarningCode(String)

	/**
	 * Removes a warning code from the record
	 *
	 * @param warningCode The warning code to remove from the record
	 */
	public void removeWarningCode(String warningCode)
	{
		if(warningCodes.contains(warningCode))
			warningCodes.remove(warningCode);
	} // end method removeWarningCode(String)

	/**
	 * Gets the record's error codes
	 *
	 * @return The record's error codes
	 */
	public List<String> getErrorCodes()
	{
		return errorCodes;
	} // end method getErrorCodes()

	/**
	 * Sets the record's error codes
	 *
	 * @param errorCodes The record's new error codes
	 */
	...
	/**
	 * Adds a error code to the record
	 *
	 * @param errorCode The error code to add to the record
	 */
	public void addErrorCode(String errorCode)
	{
		if(!errorCodes.contains(errorCode))
			errorCodes.add(errorCode);
	} // end method addErrorCode(String)

	/**
	 * Removes a error code from the record
	 *
	 * @param errorCode The error code to remove from the record
	 */
	public void removeErrorCode(String errorCode)
	{
		if(errorCodes.contains(errorCode))
			errorCodes.remove(errorCode);
	} // end method removeErrorCode(String)
	
	/**
	 * Gets the record's warnings
	 *
	 * @return The record's warnings
	 */
	...
	/**
	 * Sets the record's warnings
	 *
	 * @param warnings The record's new warnings
	 */
	public void setWarnings(List<String> warnings)
	{
		this.warnings = warnings;
	} // end method setWarnings(List<String>)

	/**
	 * Adds a warning to the record
	 *
	 * @param warning The warning to add to the record
	 */
	public void addWarning(String warning)
	{
		if(!warnings.contains(warning))
			warnings.add(warning);
	} // end method addWarning(String)

	/**
	 * Removes a warning from the record
	 *
	 * @param warning The warning to remove from the record
	 */
	public void removeWarning(String warning)
	{
		if(warnings.contains(warning))
			warnings.remove(warning);
	} // end method removeWarning(String)
	...
	public String toString() {
		...
		if (harvest != null) {
			buffer.append(" ScheduleName=" + harvest.getHarvestSchedule().getScheduleName());
		}
