 ...
 * @author Eric Osisek
 */
public abstract class EmailConfigDAO
{
	/**
	 ...
	 *
	 * @param emailconfig The EmailConfig Object to validate
	 ...
	 * @throws DataException If one or more of the fields on the passed EmailConfig Object were invalid
	 */
